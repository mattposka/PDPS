...
class _EncoderBlock(nn.Module):
    def __init__(self, in_channels, out_channels, ksize=3, dropout=False):
        super(_EncoderBlock, self).__init__()
        layers = [
            nn.Conv2d(in_channels, out_channels, kernel_size=ksize),  # 512-3+1=510
...
class _DecoderBlock(nn.Module):
    def __init__(self, in_channels, middle_channels, out_channels, ksize=3):
        super(_DecoderBlock, self).__init__()
        self.decode = nn.Sequential(
            nn.Conv2d(in_channels, middle_channels, kernel_size=ksize),
...
class UNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.enc1 = _EncoderBlock(3, 64, ksize=5)
