...
MAX_EPOCH = 100
GPU = "0"
root_dir = '/data/leaf_train/green/feb2021/'
DATA_LIST_PATH = root_dir + '256_train_stride_128/train.txt'
INPUT_SIZE = '256,256'
...
def main():
    ...
    print( 'model :,',model )
    print( 'model_summary :',summary(model) )
