...
class GUI(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        defaultFont.configure( size=32 )
        defaultTextFont.configure( size=32 )
...
#        self.num_lesions = StringVar()
    ...
    def setImageFrame( self, ):
        self.imageFrame = tk.Frame( root,bg='yellow',borderwidth=15,relief='ridge' )
        self.nextbutton()
        self.previousbutton()
    ...
    def setModelFrame( self, ):
        self.modelFrame = tk.Frame( root,bg='blue',borderwidth=15,relief='ridge' )
    ...
    def setDirFrame( self, ):
        self.dirFrame = tk.Frame( root,bg='green',borderwidth=15,relief='ridge' )
    ...
    def setLesionFrame( self, ):
        self.lesionFrame = tk.Frame( root,bg='orange',borderwidth=15,relief='ridge' )
    ...
    def setInnocFrame( self, ):
        self.innocFrame = tk.Frame( root,bg='red',borderwidth=15,relief='ridge' )
    ...
    def setDescFrame( self, ):
        self.descFrame = tk.Frame( root,bg='pink',borderwidth=15,relief='ridge' )
        ...
        self.e1 = tk.Text( self.descFrame,height=4,width=40 )
    ...
    def setRunFrame( self, ):
        self.runFrame = tk.Frame( root,bg='teal',borderwidth=15,relief='ridge' )

        self.RunwithCPUbutton = tk.Button( self.runFrame,text='Run with CPU',command=self.process )
        self.RunwithCPUbutton.grid( column=0,row=1 )
        ...
        self.RunwithGPUbutton.grid( column=0,row=0 )
