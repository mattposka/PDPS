...
class LEAFTrain(data.Dataset):
    def __init__(self, list_path, resize_size=(256, 342), mean=(128, 128, 128), scale=True,
        ...
        self.ignore_label = 0
        self.resize_h, self.resize_w = crop_size
        self.scale = scale
        self.mean = mean
    ...
    def __getitem__(self, index):
        ...
        label = cv2.resize(label,(self.resize_h,self.resize_w))
        if self.is_jitter:
        ...
        image = cv2.resize(image,(self.resize_h,self.resize_w))
